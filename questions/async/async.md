...
- **[🟢 Чем отличаются `Promise.all`, `Promise.allSettled`, `Promise.race` и `Promise.any`?](https://github.com/samatakaya1/Interview-material/blob/main/questions/async/what_is_the_difference_between_promise_all_all_settled_race_and_any.md)**
- **[🟢 Как обрабатывать ошибки в `Promise` и `async/await`?](https://github.com/samatakaya1/Interview-material/blob/main/questions/async/how_to_handle_errors_in_promises_and_async_await.md)**
